...
struct pjmedia_vid_stream
{
	...
	// POPOV: add different fields for encoder and decoder
...
// POPOV: remove this code after check (get_video_codec_info_param)
/*
...
// POPOV: remove this code after check (pjmedia_vid_stream_info_from_sdp)
/*
