																 ...
																 pjmedia_frame *frame )
{
	...
	*/
	...
	if (frame_out.size == 0) {
		if (stream->is_streaming) {
			//PJ_LOG(5,(stream->port.info.name.ptr,"Starting silence")); // POPOV: temporary disable logging this
	...
	*/
	...
	if (stream->is_streaming == PJ_FALSE) {
		...
		rtp->m = 1;
		//PJ_LOG(5,(stream->port.info.name.ptr,"Start talksprut..")); // POPOV: temporary disable logging this
	}
