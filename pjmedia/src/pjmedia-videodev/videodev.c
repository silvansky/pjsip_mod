...
pjmedia_vid_dev_myframe myframe = {NULL, NULL};
...
/* API: Pause the stream. */
PJ_DEF(pj_status_t) pjmedia_vid_dev_stream_pause(pjmedia_vid_dev_stream *strm)
{
	pj_status_t status;
